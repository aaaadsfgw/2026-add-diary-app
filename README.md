...
```bash
PROJECT_DIR=~/work/my-diary bash <(curl -fsSL https://raw.githubusercontent.com/ncc-toda/diary-app/main/setup.sh)
```

または親ディレクトリだけ変えるなら:

```bash
PROJECT_PARENT_DIR=~/work bash <(curl -fsSL https://raw.githubusercontent.com/ncc-toda/diary-app/main/setup.sh)
